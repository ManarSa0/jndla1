...
<img src="<?php bloginfo('stylesheet_directory'); ?>/assets/img/2030 (2).png" alt="">
<p>
السعودية - الرياض <br>
مخرج 24<br><br>
...
<script src="<?php bloginfo('stylesheet_directory'); ?>/assets/vendor/aos/aos.js"></script>
<script src="<?php bloginfo('stylesheet_directory'); ?>/assets/vendor/glightbox/js/glightbox.min.js"></script>
<script src="<?php bloginfo('stylesheet_directory'); ?>/assets/vendor/isotope-layout/isotope.pkgd.min.js"></script>
<script src="<?php bloginfo('stylesheet_directory'); ?>/assets/vendor/swiper/swiper-bundle.min.js"></script>
<script src="<?php bloginfo('stylesheet_directory'); ?>/assets/vendor/php-email-form/validate.js"></script>
